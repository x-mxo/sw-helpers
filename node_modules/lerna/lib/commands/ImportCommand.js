    ...
    value: function execute(callback) {
      ...
      _async2.default.series(this.commits.map(function (sha) {
        return function (done) {
          ...
          _ChildProcessUtilities2.default.exec("git", ["am", "-3"], _this3.execOpts, function (err) {
            if (err) {
              ...
              _ChildProcessUtilities2.default.execSync("git", ["am", "--abort"], _this3.execOpts);
              _ChildProcessUtilities2.default.execSync("git", ["reset", "--hard", _this3.preImportHead], _this3.execOpts);
            }
            done(err);
          }).stdin.end(patch);
        };
