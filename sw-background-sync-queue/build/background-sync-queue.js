...
(function (global, factory) {
  ...
  (factory((global.goog = global.goog || {}, global.goog.backgroundSyncQueue = global.goog.backgroundSyncQueue || {})));
...
let getResponse = (() => {
	var _ref2 = asyncToGenerator(function* (hash) {
 ...
 */
let initialize = (() => {
  var _ref = asyncToGenerator(function* ({ broadcastChannel, dbName } = {}) {
    if (broadcastChannel) {
